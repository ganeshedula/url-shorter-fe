  ...
  const verify = async () => {
    ...
    try {
      if (reset) {
        ...
        // Persist tokens + user synchronously so ProtectedRoute sees isAuthenticated = true
        // before the navigation renders the dashboard route.
        completeEmailVerification(response.data);
